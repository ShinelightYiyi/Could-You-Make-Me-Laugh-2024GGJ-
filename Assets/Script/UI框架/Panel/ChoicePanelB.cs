...
public class ChoicePanelB : BasePanel
{
    private static string name = "ChoicePanelB";
    private static string path = "Panel/ChoicePanelB";
    public static readonly UIType newUIType = new UIType(name, path);
    public ChoicePanelB() : base(newUIType)
    {
